...
public class TelaGerenInter extends JFrame{

    private Administrador admin;
    private Gerente gerente;
    private JPanel contentPane;

    public TelaGerenInter(Administrador admin, Gerente gerente) {
        this.admin = admin;
        this.gerente = gerente;
    }

    public void telaInterditaRecursos() {
        ...
        // Adicionando título
        JLabel labelTitulo = new JLabel("Interditar Recurso");
                ...
                public void actionPerformed(ActionEvent e) {
                    switch (indice) {
                        case 0:
                            ...
                            String inter = textRecurso.getText();
                            boolean interditaSucesso = gerente.interditarRecursos(inter);
